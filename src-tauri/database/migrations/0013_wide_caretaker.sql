...
ALTER TABLE `haex_file_local_sync_state` ADD `device_id` text NOT NULL;--> statement-breakpoint
...
ALTER TABLE `haex_file_sync_rules` ADD `device_id` text NOT NULL;--> statement-breakpoint
