 ...
 */
export type PasswordItemSummary = { id: string, title: string | null, username: string | null, url: string | null, icon: string | null, color: string | null, tags: Array<string>, createdAtNoSync: string | null, updatedAtNoSync: string | null, };
