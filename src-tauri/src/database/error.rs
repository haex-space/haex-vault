...
pub enum DatabaseError {
    ...
    /// directly (`haex_hlc_no_sync`, `haex_column_hlcs_no_sync`, `haex_column_sigs_no_sync`). Those
    ...
    /// clobbered by the transformer (`haex_hlc_no_sync`) or, worse, would feed a
    /// forged HLC/sig into the sig preimage (`haex_column_hlcs_no_sync`, sig-forgery
