...
pub struct HaexExtensions {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub updated_at_no_sync: Option<String>,
}
...
impl HaexExtensions {
    pub fn from_row(row: &rusqlite::Row) -> rusqlite::Result<Self> {
        Ok(Self {
            ...
            i18n: row.get(13)?,
            dev_path: row.get(14)?,
            created_at_no_sync: row.get(15)?,
            updated_at_no_sync: row.get(16)?,
        })
    }
}
...
impl HaexPrincipalPermissions {
    pub fn from_row(row: &rusqlite::Row) -> rusqlite::Result<Self> {
        Ok(Self {
            ...
            status: row.get(6)?,
            created_at_no_sync: row.get(7)?,
            updated_at_no_sync: row.get(8)?,
        })
    }
}
...
impl HaexExtensionLimits {
    pub fn from_row(row: &rusqlite::Row) -> rusqlite::Result<Self> {
        Ok(Self {
            ...
            created_at_no_sync: row.get(6)?,
            updated_at_no_sync: row.get(7)?,
        })
    }
}
...
impl HaexPasswordsItemDetails {
    pub fn from_row(row: &rusqlite::Row) -> rusqlite::Result<Self> {
        Ok(Self {
            ...
            created_at_no_sync: row.get(14)?,
            updated_at_no_sync: row.get(15)?,
        })
    }
}
...
impl HaexPasswordsGeneratorPresets {
    pub fn from_row(row: &rusqlite::Row) -> rusqlite::Result<Self> {
        Ok(Self {
            ...
            created_at_no_sync: row.get(11)?,
            updated_at_no_sync: row.get(12)?,
        })
    }
}
...
impl HaexPrincipals {
    pub fn from_row(row: &rusqlite::Row) -> rusqlite::Result<Self> {
        Ok(Self {
            ...
            name: row.get(3)?,
            enabled: row.get(4)?,
            created_at_no_sync: row.get(5)?,
            updated_at_no_sync: row.get(6)?,
        })
    }
}
