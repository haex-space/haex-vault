...
use crate::table_names::{
    ...
    COL_CRDT_MIGRATIONS_APPLIED_AT,
    COL_CRDT_MIGRATIONS_EXTENSION_ID,
    COL_CRDT_MIGRATIONS_ID,
    COL_CRDT_MIGRATIONS_MIGRATION_CONTENT,
    COL_CRDT_MIGRATIONS_MIGRATION_NAME,
    // Extensions table
    COL_EXTENSIONS_ID,
    COL_EXTENSIONS_NAME,
    COL_EXTENSIONS_PUBLIC_KEY,
    // Extension migrations table (synced, stores migration definitions)
    COL_EXTENSION_MIGRATIONS_EXTENSION_ID,
    COL_EXTENSION_MIGRATIONS_EXTENSION_VERSION,
    COL_EXTENSION_MIGRATIONS_ID,
    COL_EXTENSION_MIGRATIONS_MIGRATION_NAME,
    COL_EXTENSION_MIGRATIONS_SQL_STATEMENT,
    TABLE_CRDT_MIGRATIONS,
    TABLE_EXTENSIONS,
    TABLE_EXTENSION_MIGRATIONS,
};
