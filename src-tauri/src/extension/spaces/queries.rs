...
use crate::table_names::{
    ...
    COL_SHARED_SPACE_SYNC_TABLE_NAME, COL_SHARED_SPACE_SYNC_TYPE,
    COL_SHARED_SPACE_SYNC_TYPE_LABEL, COL_SPACE_MEMBERS_IDENTITY_ID, COL_SPACE_MEMBERS_SPACE_ID,
    TABLE_IDENTITIES, TABLE_SHARED_SPACE_SYNC, TABLE_SPACE_MEMBERS,
};
