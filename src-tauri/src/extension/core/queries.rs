...
use crate::table_names::{
    ...
    COL_EXTENSION_MIGRATIONS_SQL_STATEMENT, COL_PRINCIPAL_PERMISSIONS_ACTION,
    COL_PRINCIPAL_PERMISSIONS_CONSTRAINTS, COL_PRINCIPAL_PERMISSIONS_ID,
    COL_PRINCIPAL_PERMISSIONS_PRINCIPAL_ID, COL_PRINCIPAL_PERMISSIONS_RESOURCE_TYPE,
    COL_PRINCIPAL_PERMISSIONS_STATUS, COL_PRINCIPAL_PERMISSIONS_TARGET, TABLE_EXTENSIONS,
    TABLE_EXTENSION_MIGRATIONS, TABLE_PRINCIPAL_PERMISSIONS,
};
...
lazy_static! {
    ...
    pub static ref SQL_INSERT_EXTENSION_PERMISSION: String = format!(
        "INSERT INTO {TABLE_PRINCIPAL_PERMISSIONS} \
         ({COL_PRINCIPAL_PERMISSIONS_ID}, {COL_PRINCIPAL_PERMISSIONS_PRINCIPAL_ID}, \
          {COL_PRINCIPAL_PERMISSIONS_RESOURCE_TYPE}, {COL_PRINCIPAL_PERMISSIONS_ACTION}, \
          {COL_PRINCIPAL_PERMISSIONS_TARGET}, {COL_PRINCIPAL_PERMISSIONS_CONSTRAINTS}, \
          {COL_PRINCIPAL_PERMISSIONS_STATUS}) \
         VALUES (?, ?, ?, ?, ?, ?, ?)"
    );
