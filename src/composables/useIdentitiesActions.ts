...
import type { CreateSubmitPayload } from '@/components/haex/system/settings/identities/IdentityCreateDialog.vue'
import type {
  EditSubmitPayload,
  AvatarUpdatePayload,
} from '@/components/haex/system/settings/identities/IdentityEditDialog.vue'
import type { ImportSubmitPayload } from '@/components/haex/system/settings/identities/IdentityImportDialog.vue'
import type { ExportSubmitPayload } from '@/components/haex/system/settings/identities/IdentityExportDialog.vue'
import type {
  ClaimDialogEditTarget,
  ClaimSubmitPayload,
} from '@/components/haex/system/settings/identities/IdentityClaimDialog.vue'
import type { ListItemClaim } from '@/components/haex/system/settings/identities/IdentityListItem.vue'
...
export const useIdentitiesActions = () => {
  ...
  // =========================================================================
  // Lifecycle (parent-callable hydrate)
  // =========================================================================

  const loadIdentitiesAndSpacesAsync = async () => {
